...
vanilla_regions: tuple[RegionData, ...] = (
    ...
    RegionData(
        ...
        (
            ...
            Entrance.farmhouse_to_cellar
        ),
    ),
    RegionData(RegionName.farm_house_kitchen, (LogicEntrance.farmhouse_upgrade_crib,)),
    RegionData(RegionName.farm_house_crib),
    RegionData(RegionName.cellar, (Entrance.cellar_to_farmhouse,)),
    RegionData(
        RegionName.farm,
        (
    ...
    RegionData(LogicRegion.spring_farming, (LogicEntrance.grow_spring_crops_in_not_winter_season,)),
    RegionData(LogicRegion.summer_farming, (LogicEntrance.grow_summer_fall_crops_in_summer, LogicEntrance.grow_summer_crops_in_not_winter_season,)),
    RegionData(LogicRegion.fall_farming, (LogicEntrance.grow_summer_fall_crops_in_fall, LogicEntrance.grow_fall_crops_in_not_winter_season,)),
    RegionData(LogicRegion.winter_farming, (LogicEntrance.grow_winter_crops_in_any_season,)),
    RegionData(LogicRegion.summer_or_fall_farming),
    RegionData(LogicRegion.indoor_farming, (LogicEntrance.grow_indoor_crops_in_any_season,)),
    RegionData(LogicRegion.any_farming),
    RegionData(LogicRegion.not_winter_farming, (LogicEntrance.grow_not_winter_crops_in_any_season,)),
    ...
    RegionData(LogicRegion.raccoon_daddy, (LogicEntrance.buy_from_raccoon_1, LogicEntrance.can_complete_raccoon_requests_1,
                                           LogicEntrance.can_complete_raccoon_requests_2, LogicEntrance.can_complete_raccoon_requests_3,
                                           LogicEntrance.can_complete_raccoon_requests_4, LogicEntrance.can_complete_raccoon_requests_5,
                                           LogicEntrance.can_complete_raccoon_requests_6, LogicEntrance.can_complete_raccoon_requests_7,
                                           LogicEntrance.can_complete_raccoon_requests_8)),
    RegionData(LogicRegion.raccoon_request_1),
    RegionData(LogicRegion.raccoon_request_2),
    RegionData(LogicRegion.raccoon_request_3),
    RegionData(LogicRegion.raccoon_request_4),
    RegionData(LogicRegion.raccoon_request_5),
    RegionData(LogicRegion.raccoon_request_6),
    RegionData(LogicRegion.raccoon_request_7),
...
vanilla_connections: tuple[ConnectionData, ...] = (
    ...
    ConnectionData(LogicEntrance.grow_spring_crops_in_not_winter_season, LogicRegion.not_winter_farming),
    ConnectionData(LogicEntrance.grow_summer_crops_in_not_winter_season, LogicRegion.not_winter_farming),
    ConnectionData(LogicEntrance.grow_fall_crops_in_not_winter_season, LogicRegion.not_winter_farming),
    ConnectionData(LogicEntrance.grow_winter_crops_in_any_season, LogicRegion.any_farming),
    ConnectionData(LogicEntrance.grow_not_winter_crops_in_any_season, LogicRegion.any_farming),
    ConnectionData(LogicEntrance.grow_indoor_crops_in_any_season, LogicRegion.any_farming),
