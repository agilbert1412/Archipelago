...
class Entrance:
    ...
    farmhouse_to_cellar = "Farmhouse to Cellar"
...
class LogicEntrance:
    ...
    watch_bus_stop_krobus_cutscene = "Watch Bus Stop Krobus Cutscene"
    watch_community_center_cutscene = "Watch Community Center Cutscene"
