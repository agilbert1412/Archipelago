...
pelican_town = ContentPack(
    ...
    shop_sources={
        ...
        Seed.parsnip: (ShopSource(price=20, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.bean: (ShopSource(price=60, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.cauliflower: (ShopSource(price=80, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.potato: (ShopSource(price=50, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.tulip: (ShopSource(price=20, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.kale: (ShopSource(price=70, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.jazz: (ShopSource(price=30, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.garlic: (ShopSource(price=40, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.rice: (ShopSource(price=40, shop_region=Region.pierre_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),

        Seed.melon: (ShopSource(price=80, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.tomato: (ShopSource(price=50, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.blueberry: (ShopSource(price=80, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.pepper: (ShopSource(price=40, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.wheat: (ShopSource(price=10, shop_region=Region.pierre_shop, seasons=(Season.summer, Season.fall), forbidden_items=forbidden_items_for_seeds),),
        Seed.radish: (ShopSource(price=40, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.poppy: (ShopSource(price=100, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.spangle: (ShopSource(price=50, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.hops: (ShopSource(price=60, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),
        Seed.corn: (ShopSource(price=150, shop_region=Region.pierre_shop, seasons=(Season.summer, Season.fall), forbidden_items=forbidden_items_for_seeds),),
        Seed.sunflower: (ShopSource(price=200, shop_region=Region.pierre_shop, seasons=(Season.summer, Season.fall), forbidden_items=forbidden_items_for_seeds),),
        Seed.red_cabbage: (ShopSource(price=100, shop_region=Region.pierre_shop, seasons=(Season.summer,), forbidden_items=forbidden_items_for_seeds),),

        Seed.eggplant: (ShopSource(price=20, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.pumpkin: (ShopSource(price=100, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.bok_choy: (ShopSource(price=50, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.yam: (ShopSource(price=60, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.cranberry: (ShopSource(price=240, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.fairy: (ShopSource(price=200, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.amaranth: (ShopSource(price=70, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.grape: (ShopSource(price=60, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),
        Seed.artichoke: (ShopSource(price=30, shop_region=Region.pierre_shop, seasons=(Season.fall,), forbidden_items=forbidden_items_for_seeds),),

        Seed.broccoli: (ShopSource(items_price=((5, Material.moss),), shop_region=LogicRegion.raccoon_shop_1, forbidden_items=forbidden_items_for_seeds),),
        Seed.carrot: (ShopSource(items_price=((1, TreeSeed.maple),), shop_region=LogicRegion.raccoon_shop_1, forbidden_items=forbidden_items_for_seeds),),
        Seed.powdermelon: (ShopSource(items_price=((2, TreeSeed.pine),), shop_region=LogicRegion.raccoon_shop_1, forbidden_items=forbidden_items_for_seeds),),
        Seed.summer_squash: (ShopSource(items_price=((15, Material.sap),), shop_region=LogicRegion.raccoon_shop_1, forbidden_items=forbidden_items_for_seeds),),

        Seed.strawberry: (ShopSource(price=100, shop_region=LogicRegion.egg_festival_shop, seasons=(Season.spring,), forbidden_items=forbidden_items_for_seeds),),
        Seed.rare_seed: (ShopSource(price=1000, shop_region=LogicRegion.traveling_cart, seasons=(Season.spring, Season.summer), forbidden_items=forbidden_items_for_seeds),),
