...
from ..strings.ap_names.ap_option_names import ChefsanityOptionName, EatsanityOptionName, HatsanityOptionName
from . import options
...
easy_settings = {
    ...
    options.QuestLocations.internal_name:                "few",
...
medium_settings = {
    ...
    options.QuestLocations.internal_name:                "medium",
